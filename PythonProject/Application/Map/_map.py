...
class Map:
    ...
    def generate_demo_shop(self) -> None:
        self.tiles_dictionary[Vector2d(-10, -10)]=Tile(Vector2d(-10,-10),{})
        self.tiles_dictionary[Vector2d(-10, 0)]=Tile(Vector2d(-10,0),{})
        self.tiles_dictionary[Vector2d(-10, 10)]=Tile(Vector2d(-10,10),{})
        self.tiles_dictionary[Vector2d(0, 10)]=Tile(Vector2d(0,10),{})
        ...
        self.tiles_dictionary[Vector2d(-10, -10)].generate_demo_turn("upper left")
        self.tiles_dictionary[Vector2d(-10, 0)].generate_demo_straight("left",shop_tile=True)
        self.tiles_dictionary[Vector2d(-10, 10)].generate_demo_turn("lower left")
        ...
        self.tiles_dictionary[Vector2d(10, -10)].generate_demo_turn("upper right")
        self.tiles_dictionary[Vector2d(10, 0)].generate_demo_straight("right",shop_tile=True)
        self.tiles_dictionary[Vector2d(10, 10)].generate_demo_turn("lower right")
